...
| Y6 | The morning's laps are what the archive holds | **SIX OF 24 CARRY A 100 % BRAKE AT EXACTLY 5,200 m ON THE BANKING** (267 → 110–190 km/h, then full throttle, no pit), costing that lap 1–2 s and the next lap's front stretch (254 vs 284 km/h). Also on s119 L10. Not setup. **Asked** - traffic, gap-building, track-limit reset or a pit-entry feint all fit. Until answered, every banking and straight-line figure in the car-state file excludes those laps and the lap after |
