...
**The undercut is strong and track position is expensive.** Overtaking is realistically T2 only, plus the occasional Corkscrew move that ends in tears. **Within about a second of the car ahead at lap 9 — pit first.** Fresh Softs plus full power on the out-lap into T2 is the strongest weapon you have all race.
