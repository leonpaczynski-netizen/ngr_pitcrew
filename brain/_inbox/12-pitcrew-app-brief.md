# Pit Crew App — Build Brief

**What this is:** the project-instructions file (`CLAUDE.md`) given to the Claude Code
session rebuilding the Pit Crew app, preserved here so this knowledge base knows what
the app is supposed to do and what GT7 will and will not let it do. Written 11 Aug
2026 · GT7 v1.70.

The schema it builds against is `10-pit-crew-data-format.md` (`gt7-pitcrew/1.1`).
