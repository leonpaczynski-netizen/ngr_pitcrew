...
2026-09-09,s153 (14 laps),n/a (full-stint RR wear rate vs early-life),n/a,n/a,HUD wear gauge,gauge tick 0.0278,s130-132 rate 0.0528,full-stint rate is at or above 0.0528/lap (short runs are a lower bound),12-lap rate below 0.0528,open,"§12 amended row 3. §14/§21 report RH s153 at 0.0498 +/- 0.0006, below 0.0528 but inside the uncertainty of the 0.0528 reference itself (+/-0.0056/lap over the 5-lap runs behind it; s153's own is +/-0.0006); never scored. See (b)-R12",Rev F
...
- **R12.** §12 predicts the full-stint rate ≥ 0.0528, with "below 0.0528" as the falsifier. §14
  ...
  the uncertainty of the 0.0528 reference (±0.0056/lap over its 5-lap runs; s153's own is ±0.0006) and the file never scores it. Kept: `open`, flagged.
...
### 3d. 15 Sep evening: the second race sim, strategy 34 (session 179)

```csv
date,session_ids,key,direction,delta_pct_range,instrument,measured_floor,control,prediction,falsifier,outcome,source,car_state_rev
2026-09-15,s179,n/a (3c race plan: RM to lap 12),n/a,n/a,HUD wear gauge; lap time; frames at each off,gauge tick 0.0278,s177 stint 1,RM to the end of lap 12 with no tyre-led slide and RR under 89 %,a tyre-led slide before the stop or RR past 89 % by lap 12,confirmed,"§50; RR 72 % at L11 (s177 75 %); the L9 spin was a tarmac rear slide at 53-58 % RR - before the cliff, so not scored as tyre-led; its cause is asked (measurement 142)",Rev H
2026-09-15,s179,n/a (3c race plan: RH to the flag),n/a,n/a,HUD wear gauge; lap time,gauge tick 0.0278,s156 RH at the beep,RH reaches the flag under 90 % with flat laps,RR past 90 % before the last lap or the last three laps >1 s off the stint median,confirmed,"§50; 16 laps RR 83 % (0.052/lap incl. 4 laps at full revs and 2 spins); clean laps 102.1-103.8, L26 is the spin",Rev H
2026-09-15,s179,n/a (3c race plan: +3 L fill lands 2-4 L),n/a,n/a,fuel at the flag,n/a,n/a,+3 L over laps-left x stint-1 burn lands 2-4 L at the flag,dry or >6 L left,unresolvable,"§50; not run as stated - George filled for 17 laps plus a spare lap (97 L); the flag read 4.9 L only after ~6 L were burned at full revs L25-28 (measurement 141)",Rev H
2026-09-15,s179,n/a (§49 1: George's stop fill),n/a,n/a,race_revisions; replay_race_calls,n/a,replay of the same laps,the fill George names lands within ~2 L of laps left x stint-1 burn,a fill 5 L+ over,refuted,"§50; live 'Fuel to 97 litres' against 17 x 5.34 = 90.8 (+6 L, a spare lap past the 29-lap ceiling); the replay on the same code says 91. App work, measurement 141",Rev H
2026-09-15,s179,n/a (§49 2: full-beeps switch),n/a,n/a,upshift rpm per lap; pitcrew.log,n/a,n/a,no Full beeps in stint 1; in stint 2 only once the tank reaches at full revs,a full-revs switch followed by a fuel-short call inside three laps,unresolvable,"§50; stint 1 all 7,370-7,414 (that half confirmed); 8,400 from L25 with no fuel-short call after and 4.9 L at the flag, but no 'Full beeps' is in the live log while the replay calls it at lap 22 - whether George or the driver switched is asked",Rev H
2026-09-15,s179,n/a (§49 3: beep from the grid),n/a,n/a,upshift rpm lap 1,n/a,n/a,the beep is on 7,400 from the grid,the beep at 8,500 on lap 1,confirmed,"§50; L1 upshift 7,400",Rev H
2026-09-15,s179 v s156/s153; control s179 RM v s177 RM,n/a (RH grip into the evening),n/a,n/a,exit wheelspin share (rear slip >1.08 at >=50 % throttle); tyre temps; [DRIVER REPORT],not established,s177 RM evening v daylight (0.9 v 1.1 %); s179 RM daylight v s177 RM daylight (2.8 v 1.1 %),[DRIVER] the hard goes slippery as the evening cools,evening RH no looser than daylight RH once tonight's session-wide rise is removed,unresolvable,"§50; RH free air tyre laps 7-12: 4.1 % v 2.3 %, temps within 1-2 C, ~1.2 s a lap quicker; but tonight's DAYLIGHT medium was 2.5x s177's too, and s177's evening medium was no looser than its daylight. The feed has no track temperature. Measurements 139-140",Rev H
...
- RH evening row: `[DRIVER]` *"hards just felt looser as the stint went on"* - a within-stint trend, where wear and the clock move together. Exit wheelspin rose ~2 % (L14-16) -> 4-5.5 % (L20-28); daylight s156 rose the same way with wear (~2 % -> 4-6 % past ~64 % RR). Consistent with wear; the evening still cannot be separated. Row unchanged.
- Lap 29 (measurement 143): no single off cost it; lap 26 plus either other did. Lap 26 alone missed it by 4.7 s - inside the ~6 s of spare-lap fuel.
- Dark at the blind left: `[DRIVER]` *"not harder to see just adjusting from RM to RH and less grip"* - visibility ruled out. Pooled minimum speed through the blind left (3,640-3,760 m): s179 RH 13 laps 155-168 km/h (median ~160) against s156 daylight RH practice ~159 and s177 free-air RM stint 2 ~164; tonight's RM stint 1 (119-151) is traffic and not comparable. On average he was already driving the hard at the hard's speed. The two hard offs are the top of that range: L18 min 166, L26 arrived 215 km/h at 3,640 m against 183-199 on every other hard lap. [DERIVED], pooled, no input marker issued.

### 3f. 16 Sep: Rd 9 race (s188), debriefed 17 Sep - closes §58 and §59

```csv
date,session_ids,key,direction,delta_pct_range,instrument,measured_floor,control,prediction,falsifier,outcome,source,car_state_rev
2026-09-16,s188,n/a (§58 1: stint 2 filled to 93 L lands 1-2 L at the flag),n/a,n/a,lap_frames fuel_l,n/a,n/a,93 L reaches the flag with 1-2 L in hand on the beep,under 0.5 L or over 4 L with no full-revs laps,unresolvable,"§60; not run as stated - George called 89 L and the tank read 88.1 L at the start of L13. Result: dry ~110 m before the line on L29 (measurement 168). The plan's 93 L would have landed ~4 L",Rev I
2026-09-16,s188,n/a (§58 2: George says ~97 L again),n/a,n/a,race_revisions,n/a,n/a,George says ~97 L from the practice burn,he says 91-93 or the burn installs,refuted,"§60; he said 'Fuel to 89 litres ... at this race's burn' - the b51f680 fix installed the race burn, and the fill came out with no margin at all. App work filed",Rev I
2026-09-16,s188,n/a (§58 3: free air on the beep within 0.3 s of target),n/a,n/a,lap time,not established,strategy 37 targets,RM within 0.3 s of 102.370 and RH of 103.387,consistently >0.5 s either side,confirmed,"§60; RM L7-11 median 102.54 (+0.17); RH L18-24 median 102.97 (-0.42, quicker, inside the 0.5 falsifier); burn 5.21 against 5.365",Rev I
2026-09-16,s188,n/a (§58 4: next big loss is an off-throttle rear release at high lock),n/a,n/a,per-wheel slip; yaw; surface,n/a,n/a,the next big loss is an off-throttle rear release,a braking lock-up or a throttle-on slide,unresolvable,"§60; the big loss was L29 T3 side by side with Boxhead: arrived 212 km/h against 188-190, lat g 1.0 -> 0.02 at turn-in (contact - [DRIVER] confirmed 17 Sep: Boxhead hit him, ticket lodged; measurement 172), no lock, brakes on to the gravel. A race incident, not a car failure mode (measurement 170)",Rev I
2026-09-16,s188,top_6th (§59 1.348 -> 1.318),longer,n/a (gear ratio),rev_limiter in 6th; terminal speed,not established,s183 same beep old 6th,zero limiter frames in 6th; terminal within 1 km/h of 269 on RM,terminal drops >1.5 km/h or 6th tops below 8000 rpm in free air,unresolvable,"§60; limiter half confirmed (0 of 37,444 sixth-gear frames). Terminal RM 259 vs s183 269 but RH 260 vs 259-260 unchanged - wind (HUD 3.9-5.7 m/s) not controlled, so the gear cannot be charged or cleared (measurement 171). Lap times on target",Rev I
```

**Notes, 3f**
- Every place lost on track after lap 6 went up his LEFT, the inside of a left-hander, off a tow: CruisingChaos L25 hairpin, Rocky L26 T3, Jubby L28 T1, Boxhead L29 T3 (measurement 170). Tommy was passed when Tommy went off at the blind left on L6, not by a move.
- `[DRIVER]` 17 Sep: *"Lap 29 T3 boxhead hit me I have lodged a ticket"* - contact confirmed, the telemetry agrees (measurement 172).
- `[DRIVER]` *"held Rocky off"* - the replay board has Rocky past on L26 into T3; surfaced to him, not averaged.
- George's Rocky calls: numbers from L16, one rate call at 1.8 s on L23, no catch lap - a 3-lap rate said "lap 25-26" from L20 (measurement 169). App work filed.
