...
2026-09-04,s119 -> s120,df_f,up,+40.0,"suspension compression at speed; RR wear; terminal speed; rear temp; lap time","terminal 0.56-2.77 km/h; lap time cannot rank (F5); others not established",s119 (3 Sep other day),'more aero to look after the rears' (3 Sep),load/wear unmoved,refuted,"§4 Sep five A/B runs, run 5; F4; F7; AXIS-REGISTER df row ('Invisible')",run 5
2026-09-04,s120 -> s121,df_r,up,+25.0,"rear compression at 270 km/h (+0.65 mm); wear; terminal; rear temp","terminal 0.56-2.77 km/h; others not established",s120,'more aero to look after the rears',load/wear unmoved,refuted,"§4 Sep run 6; F4; F7",run 6
...
2026-09-08,s145 -> s146,lsd_a,up,+12.0 (+6.0 from the pre-s145 setting),on-power rotation index T5 exit,T5 0.00104,config C (n=3); race config A (n=15),T5 index rises above 0.0089; front scrub below +0.0082,index at or below 0.00788,refuted,"§s145 'NEXT CHANGE, ISSUED, session 146'; §s146 'FALSIFIER 1 FAILED' (0.00748 n=10)",s146 (s147's table calls it config C)
...
2026-09-08,s146 -> s147,lsd_b,up,+5.0,laps with sub-0.90 rear frames at T1 (240-425 m),none stated; the file says ~22 laps needed to prove absence,2 of 15 laps (s146),laps with rear brake lock at T1 fall to 0,rate unchanged over 12 laps,confirmed,"§s147 as RUN; §s147 'it WORKED' (0 of 5). The file's own power arithmetic says n=5 is short; see (b)-D5",config D
...
2026-09-08,s149,arb_r,stiffer,+22.2,Bus Stop grass rate,not established,9 of 17 laps at the previous rear bar,named risk: stiffer rear bar makes the Bus Stop launch worse,grass rate rises,refuted,"§s148 'THE RISK'; §s149 'The risk I named did NOT happen' (3 of 9)",config F
...
2026-09-04,s120-s150 (Bus Stop),n/a (Bus Stop kerb launch),n/a,n/a,Bus Stop grass rate; RR wheel extension,not established,n/a,an extension event; rear rebound is the lever (tested: refuted),n/a,open,"§7 Sep 'de 46/44 is the untried axis'; §s150 (the de_r lever was refuted, launch remains)",-
```
...
- dc: −8 ÷ 20 = −40.0 pp front, −6 ÷ 20 = −30.0 pp rear. The
  ...
  out-of-range value was once proposed for dc_r (below the 20 floor).
...
- **D5.** s147 scores the stiffer `lsd_b` as "it WORKED" on T1 rear lock at **0 of 5 laps**. The
  ...
  requested 12. The AXIS-REGISTER repeats "does kill the rear brake lock". Kept: `confirmed` as
  the file states it, **flagged as underpowered by the file's own arithmetic**.
...
- **D9.** `dc` softer is "FALSIFIED at the Bus Stop" (AXIS-REGISTER; Daytona line 267). The
  ...
  the instrument, with the standing driver disagreement noted. The ledger should carry both.
