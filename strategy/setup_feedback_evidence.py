...
# NOTE: the structured Practice-Review dropdowns are read NATIVELY by the setup
# brain — see strategy.setup_diagnosis.driver_feel_flags_from_feedback and the
# `feedback` parameter of build_setup_diagnosis. There is deliberately no
# dropdown-to-phrase converter here: the brain understands the exact dropdown
# values directly rather than round-tripping them through free text.
