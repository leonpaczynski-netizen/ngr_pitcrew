...
#define DEVICE_NAME "Redion Wind Sim" //{"Group":"General","Name":"DEVICE_NAME","Title":"Device name,\r\n make sure to use a unique name when using multiple arduinos","DefaultValue":"SimHub Dash","Type":"string","Template":"#define DEVICE_NAME \"{0}\""}
#define DEVICE_UNIQUE_ID "c3bcb391-760c-4eee-89cb-232246fce7dc" //{"UniqueId":"c3bcb391-760c-4eee-89cb-232246fce7dc","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
// --------------------------------------------------------------------------------------------------------
#define ADAMOTORS_SHIELDSCOUNT 1 //{"Group":"SHAKEIT Adafruit Motorshield V2","Name":"ADAMOTORS_SHIELDSCOUNT","Title":"Number of adadruit shields connected (up to 3)","DefaultValue":"0","Type":"int","Max":3}
#ifdef INCLUDE_SHAKEITADASHIELD
#define ADAMOTORS_FREQ 1200      //{"Name":"ADAMOTORS_FREQ","Title":"PWM Frequency of the board (1900hz max)","DefaultValue":"1900","Type":"int","Condition":"ADAMOTORS_SHIELDSCOUNT>0","Min":10,"Max":1900}
