...
| DEF-UAT-073-012 | Medium (UX clarity) | home_command_centre (Event Briefing dept) | OPEN — "Event Briefing" department's purpose is unclear; navigates to the Development History catch-all |
